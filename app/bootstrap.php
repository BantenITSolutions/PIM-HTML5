 ...
 * | GET             | /cool-stuff                          | Cool Stuff            |
 * | GET             | /cool-stuff/desktop-notification     | Browser notification  |
 * | GET             | /cool-stuff/preview                  | Filesystem API        |
 * | GET             | /cool-stuff/dirupload                | Directory API         |
 * | GET             | /cool-stuff/canvas-animation         | Canvas Animation      |
...
$app->get('/cool-stuff/desktop-notification',function(Request $request) use ($app){
    return $app['twig']->render('twig/cool/desktop-notification.tpl',$app['data']);
});
